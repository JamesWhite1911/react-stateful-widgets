...
import React, { useState } from 'react'; /* STEP 0 */  // adding { useState } to this is importing the state hook

export default function Counter() {
  /* STEP 1 */
  let [count, setCount] = useState(0); // create a pair "count" and set state to 0
