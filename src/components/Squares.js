...
export default function Squares() {
  ...
  const markActive = id => {
    ...
    // Set the id argument to become the active id in state (unless it already is, in which case we should reset the currently active square id back to initial state).
